        ...
        var recurseDependencies = function (reqs) {
            ...
            if (_.size(requestPromises) >= _.size(reqs)) {
                ...
                _.each(requestPromises, function(rp, key) {
                    ...
                    var dependent = _.filter(reqs, function(request, dKey) {
                    ...
                    if (dependent) {
                        requestPromises[dependentKey] = rp.then(function( dependencyResponse ) {
                            console.log( dependencyResponse ); // This is the JSON response from the dependency
                            console.log( dependent ); // This is the JSON request from the dependent
                            ...
                            jsonRequest = template( jsonRequest, { dependency: dependencyResponse } );
