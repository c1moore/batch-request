                ...
                _.each(requestPromises, function(rp, key) {
                    ...
                    if (dependent) {
                        ...
                        _.each(dependent.dependency, function( dependencyKey ) {
                            dependencyPromisesArray.push( requestPromises[ dependencyKey ] );
                        });
                        debug( 'dependencyPromisesArray', dependencyPromisesArray );

                        requestPromises[ dependentKey ] = Promise.all( dependencyPromisesArray ).then( function( dependencyResponses ) {
                            debug( 'dependencyResponses', dependencyResponses );
                            // Looking good here.  dependencyResponses is an array of responses from the dependencyPromisesArray
                            ...
                            console.log( 'modified dependent', dependent );
